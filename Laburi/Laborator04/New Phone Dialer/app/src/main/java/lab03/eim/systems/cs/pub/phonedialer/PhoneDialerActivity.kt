...
class PhoneDialerActivity : AppCompatActivity() {
            ...
            when (p0?.id) {
                ...
                R.id.imageButton -> {
                    ...
                    if (phoneNumber.isNotEmpty()){
                        ...
                        Toast.makeText(getApplication(), "Phone number received from intent is null!", Toast.LENGTH_LONG).show();
                    }
                }
                R.id.imageButton3 -> {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val buton16: ImageButton = findViewById(R.id.imageButton)
        buton16.setOnClickListener(listener)
    }
}